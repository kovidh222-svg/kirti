  ...
  return (
    <div className="w-full h-[100dvh] bg-background relative overflow-hidden">
      ...
      <div className="fixed top-20 left-0 right-0 z-10 p-6 pointer-events-none">
        <h1 className="max-w-[750px] mx-auto text-foreground text-center font-instrument-serif px-4 md:px-6 md:text-6xl text-3xl text-balance tracking-tight font-normal leading-tight">
          The cosmos is within us. We are made of star-stuff. We are a way for the universe to know itself.
        </h1>
        <p className="mt-6 text-foreground/80 text-center font-instrument-serif text-base md:text-xl">
          Kovidh • Pranieth • Manoritha • Bhindu
        </p>
        <p className="mt-2 text-foreground/80 text-center font-instrument-serif text-base md:text-xl">
          Philip • Tanmayi • Ashritha • Nithin
        </p>
        <p className="mt-6 text-foreground/60 text-center font-instrument-serif text-sm md:text-lg italic">
